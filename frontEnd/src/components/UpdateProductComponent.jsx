...
const UpdateProductComponent = () => {
    ...
    const updateProduct = (e) => {
        ...
        if (productName === '' || productDefinition === '' || category   === '' || price === '' || image === ''){
            ...
            Tab = window.open("http://localhost:8080/admin/updateProduct?productName="+productName+"&productDefinition="+productDefinition+"&productCategory="+productCategory+"&price="+price+"&productId="+productId+"&image="+image+"&category="+category,"_blank");
            Tab.close();
            navigate("/admin");
